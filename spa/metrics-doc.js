...
window.METRICS = {
  ...
  market_cap: {
    ...
    why: 'Determines liquidity, index inclusion, and whether a position size is feasible. Click the Mkt Cap column header to filter out micro-caps where you can\'t exit a meaningful position (a ~S$200M floor is a common cut-off).',
